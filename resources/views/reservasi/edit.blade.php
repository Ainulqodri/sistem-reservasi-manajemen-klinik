...
@section('content')
    <div class="container">
        <div class="bg-white p-3 rounded shadow">
            <h4 class="fw-bold">Edit Reservasi</h4>
        </div>
        <hr>
        ...
        <form action="{{ route('reservasi.update', $reservasi->id_reservasi) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <select name="id_pasien" class="form-control" required>
                    @foreach ($pasien as $p)
                        <option value="{{ $p->id_pasien }}" {{ $p->id_pasien == $reservasi->id_pasien ? 'selected' : '' }}>
                            {{ $p->nama }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="no_antrian" class="form-control" value="{{ $reservasi->no_antrian }}" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="time" name="waktu_reservasi" class="form-control" value="{{ $reservasi->waktu_reservasi }}"
                    required>
            </div>
            ...
            <div class="mb-3">
                ...
                <select name="status" class="form-control" required>
                    ...
                    <option value="Dibatalkan" {{ $reservasi->status == 'Dibatalkan' ? 'selected' : '' }}>Dibatalkan
                    </option>
                </select>
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="keluhan" class="form-control" required>{{ $reservasi->keluhan }}</textarea>
            </div>
